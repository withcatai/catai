    ...
    <div className="h-full w-full flex flex-col">
      ...
      >
        {isEmpty ? (
          ...
          >
            <div className="mb-4 w-20 h-20 rounded-full overflow-hidden flex items-center justify-center bg-gradient-to-br from-primary-100 to-accent-100 dark:from-primary-900/30 dark:to-accent-900/30">
              <img
                src="/logo.png"
                alt="CatAI"
